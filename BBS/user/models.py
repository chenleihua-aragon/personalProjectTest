...
class User(models.Model):
    ...
    inform_comment = models.DateTimeField(blank=True, null=True, verbose_name='上次查看评论我的时间')

    inform_reply = models.DateTimeField(blank=True, null=True, verbose_name='上次查看回复我的时间')

    inform_up = models.DateTimeField(blank=True, null=True, verbose_name='上次查看点赞我的时间')

    inform_follow = models.DateTimeField(blank=True, null=True, verbose_name='上次查看关注我的时间')
